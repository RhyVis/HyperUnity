...
public class Building_WealthCovert : ThingClass
{
  ...
  public override IEnumerable<Gizmo> GetGizmos()
  {
    ...
    yield return new Command_Action
    {
      defaultLabel = "R_HyperUnity_CompResourceCovert_Gizmo1_Label".Translate(ModeLabel),
      defaultDesc = "R_HyperUnity_CompResourceCovert_Gizmo1_Desc".Translate(),
      icon = _mode == 0 ? ThingDefOf.Silver.uiIcon : ThingDefOf.Gold.uiIcon,
      action = delegate { _mode = _mode == 0 ? 1 : 0; }
    };
  }
  ...
  public override string GetInspectString()
  {
    ...
    sb.Append("R_HyperUnity_CompResourceCovert_Info".Translate(_leftoverSilverValue));
    return sb.ToString();
  }
  ...
  {
    var things = GetSlotGroup().HeldThings
      .Where(t => _mode == 0 ? t.def != ThingDefOf.Silver : t.def != ThingDefOf.Gold).ToList();
    ...
    MoteMaker.ThrowText(
      ...
      Map, "R_HyperUnity_CompResourceCovert_Mote".Translate(silverValue));
  ...
  private void TryPlace(bool calledByPlayer = false)
  {
      ...
      while (_leftoverSilverValue > 0)
      {
        ...
        if (_leftoverSilverValue > silverLimit)
        {
          ...
          else
          {
            ...
            this.ThrowMote("R_HyperUnity_CompResourceCovert_MoteFailure".Translate(_leftoverSilverValue));
            _autoPlace = false;
            break;
          }
        }
    ...
    else
    {
      ...
      var goldValue = (int)(_leftoverSilverValue / ThingDefOf.Gold.BaseMarketValue);
      ...
      while (goldValue > 0)
      {
        ...
        else
        {
          ...
          {
            Msg.E($"Failed to place gold {goldValue} at {Position}");
            this.ThrowMote("R_HyperUnity_CompResourceCovert_MoteFailure".Translate(_leftoverSilverValue));
            _autoPlace = false;
            break;
          }
