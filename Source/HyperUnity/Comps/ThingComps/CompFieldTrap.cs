...
namespace HyperUnity
{
  ...
  public class CompFieldTrap : ThingComp
  {
    ...
    public override void PostSpawnSetup(bool respawningAfterLoad)
    {
      ...
      if (_powerTrader == null) Log.Error("[HyperUnity] CompPowerTrader needed for CompFieldTrap!");
    }
    ...
    {
      base.CompTick();
      if (!parent.IsHashIntervalTick(Props.checkInterval) || !_powerTrader.PowerOn || !_activated ||
